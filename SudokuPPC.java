...
//package etud.fr.univ_montpellier.iut.sudokuPPC.ppc;
...
public class SudokuPPC {
	...
	public static void main(String[] args) throws ParseException {
		...
		if (helpMode) {
			...
			formatter.printHelp("sudokuPPC", options, true);
			System.exit(0);
		}
		instance = 4;
	...
	private static Options configParameters() {
		...
		final Option instOption = Option.builder("i").longOpt("instance").hasArg(true).argName("sudokuPPC instance")
				.desc("sudokuPPC instance size").required(false).build();
